      ...
      <main className="max-w-container-max mx-auto px-margin-desktop py-20 space-y-32">
        ...
        <section className="space-y-12">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter ${isRtl ? 'direction-rtl' : ''}`}>
            ...
            <div className="bg-surface-container-high card-accent-border p-8 space-y-6 group transition-all hover:bg-surface-container-highest flex flex-col justify-between">
        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
            ...
            <div className={`flex flex-col md:flex-row bg-surface-container-high card-accent-border overflow-hidden ${isRtl ? 'md:flex-row-reverse text-right' : 'text-left'}`}>
        ...
        <section className="space-y-12">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter ${isRtl ? 'direction-rtl' : ''}`}>
            <div className="bg-surface-container-low border border-outline-variant/20 p-10 relative overflow-hidden group">
